...
| `docs/IMPLEMENTATION_ROADMAP.md` | Product/Engineering Lead | Phase-oriented implementation roadmap snapshot | Milestone-level updates or when superseded by master planning |
